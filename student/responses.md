...
- Record ID: f4f799e5-2508-4946-9e4c-e235221d577d
...
**Student response:**
```
A downward force aft of the CG gives a nose-up moment because the force on a body about a pivot results in motion opposite to the direction of the force; here, the pivot is the center of gravity.
For example, in a seesaw, the force on one end leads the opposite motion in the other end.
```
